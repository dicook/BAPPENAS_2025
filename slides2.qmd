...
:::
::: {.column width="70%"}
```{r side-by-side bars of males females, fig.width=8, fig.height=5, echo = F, out.width="70%"}
tb_idn |> filter(year == 2012) |>
  ggplot(aes(x=sex, y=count, fill=sex)) +
    geom_bar(stat="identity", position="dodge") + 
    facet_wrap(~age, ncol=6) +
...
```{r piecharts of males females, fig.width=8, fig.height=5, echo = F, out.width="70%"}
tb_idn |> filter(year == 2012) |>
...
::: {.column width="70%"}
```{r side-by-side bars of age, fig.width=8, fig.height=5, echo = F, out.width="70%"}
tb_idn |> filter(year == 2012) |>
  ggplot(aes(x=age, y=count, fill=age)) +
    geom_bar(stat="identity", position="dodge") + 
    facet_wrap(~sex, ncol=6) +
...
```{r piecharts of age, fig.width=8, fig.height=5, echo = F, out.width="70%"}
tb_idn |> filter(year == 2012) |>
...
```{r stacked bars of age, fig.width=8, fig.height=5, echo = F, out.width="70%"}
tb_idn |> filter(year == 2012) |>
  ggplot(aes(x=1, y=count, fill=age)) +
    geom_bar(stat="identity", position="fill") + 
    facet_wrap(~sex, ncol=6) +
